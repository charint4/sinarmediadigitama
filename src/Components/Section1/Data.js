export default [
    {
        ...
        head: "PT. Sinar Media Digitama has the vision to offer 360 marketing services for creative entrepreneurs who need a one-stop service for their marketing campaign needs.",
