import brandingProduction from "../../Images/ourServices/BRANDING-icon.png";
import creativeDevelopmentPromotional from "../../Images/ourServices/CREATIVE-DEV-icon.png";
import events from "../../Images/ourServices/EO-icon.png";
import talent from "../../Images/ourServices/KOL-icon.png";
import outOfHome from "../../Images/ourServices/OOH-icon.png";
import promotional from "../../Images/ourServices/POSM-icon.png";
import printedMaterial from "../../Images/ourServices/PRINTED-icon.png";
import socialMediaManagement from "../../Images/ourServices/SMM-icon.png";
...
export default [
  ...
  },
  {
    ...
    textNotBold: "Units (POSM)",
    textBold: "Promotional",
    cover: promotional,
    ava: promUnit,
  ...
  },
  {
    ...
    textBold: "Branding",
    textNotBold: "Production",
    cover: brandingProduction,
    ava: brandingPro,
    texts: "All business owners are aware of how crucial exhibitions are to their sales approach.",
    textId: "All business owners are aware of how crucial exhibitions are to their sales approach.",
    quotes: "read more",
    description:
  ...
  },
  {
    ...
    textNotBold: "Creative Dev",
    textBold: "Promo Units",
    cover: creativeDevelopmentPromotional,
    ava: creDev1,
    texts:
      "Give you a creative recommendation to promote your brand's campaign",
    textsId:
      "Give you a creative recommendation to promote your brand's campaign",
    quotes: "read more",
    description:
  ...
  },
  {
    ...
    textNotBold: "Material",
    textBold: "Printed",
    cover: printedMaterial,
    ava: printMat,
